...
public class Insert {
    ...
    public Insert() {
        ...
        try {
            ...
            //Beer
            badwiser = objectModel.createBeer("Code1","badwiser","BW","t1",10.3,2,"desc","beer1.png");
            objectModel.storeBeer(badwiser);
            System.out.println("Entity objects badwiser created and saved.");

            
            corola = objectModel.createBeer("Code2","corola","cr","t2",7.23,4,"desc","beer2.png");
            objectModel.storeBeer(badwiser);
            System.out.println("Entity objects corola created and saved.");
            
            light = objectModel.createBeer("Code3","light","sl","t3",5,1,"desc","beer3.png");
